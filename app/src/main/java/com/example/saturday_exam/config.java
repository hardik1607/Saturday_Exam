package com.example.saturday_exam;
...
public class config {
    ...
    public static  String[] category_name={"life","art","earth","cityscapes","landscape"};

    public static  String[] life_name={"life1","life2","life3","life4","life5"};

    public static int[] life_image={R.drawable.life1,R.drawable.life2,R.drawable.life3,R.drawable.life4,R.drawable.life5};
    ...
    public static int[] earth_image={R.drawable.earth1,R.drawable.life2,R.drawable.life3,R.drawable.life4,R.drawable.life5};
